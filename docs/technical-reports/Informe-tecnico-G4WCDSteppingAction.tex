...
\vspace{2.2cm}
{\Huge\bfseries\color{tituloColor} Mejoras de la clase\\[0.2cm]
\texttt{G4WCDSteppingAction}}
...
\centering
\textit{``Registro de la respuesta neutrónica y electromagnética del detector Cherenkov de agua''}
\end{minipage}
